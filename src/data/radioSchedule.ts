...
export const radioSchedule: Show[] = [
  {
    ...
    segments: [
      {
        label: "Opener",
        description: "High‑energy introduction with show ident and welcome.",
      },
      {
        label: "Stinger 1",
        description:
          "Quick ident reminding listeners they’re tuned to HOTMESS Radio.",
      },
      {
        label: "Sponsor Read",
        description: "Promotion for HNH MESS lube with a call‑to‑action.",
      },
      {
        label: "Consent Cue",
        description:
          "Reminder that this is a men‑only, 18+ broadcast and listener consent is required.",
      },
      {
        label: "Wetter Watch",
        description: "Playful weather update delivered with a cheeky twist.",
      },
      {
        label: "Closing",
        description: "Affirmations to carry listeners through the day.",
      },
    ],
  },
  {
    ...
    segments: [
      ...
      {
        label: "Call‑in Segment",
        description: "Listeners call in to share stories and questions.",
      },
      {
        label: "Stinger 2",
        description: "Second show ident to keep the energy up.",
      },
      {
        label: "Sponsor Read",
        description: "Highlight of a featured product or upcoming drop.",
      },
      {
        label: "Closing",
        description:
          "Wrap‑up and affirmation reminding listeners to care for themselves.",
      },
    ],
  },
  {
    ...
    segments: [
      {
        ...
        description: "Guided breathing exercise to decompress.",
      },
      {
        label: "Guest Chat",
        description: "Interview with a guest expert or community member.",
      },
      {
        label: "Aftercare Tips",
        description: "Practical advice on hydration, rest and communication.",
      },
      {
        label: "Consent Cue",
        description: "Reminder of consent and men‑only space.",
      },
      {
        label: "Closing",
        description: "Gentle affirmation and encouragement for the week ahead.",
      },
    ],
  },
];
