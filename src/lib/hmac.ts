const LINK_SIGNING_SECRET = import.meta.env.LINK_SIGNING_SECRET || 'mock-link-secret-for-hmac-verification'

export async function verifyHMAC(payload: string, signature: string): Promise<boolean> {
