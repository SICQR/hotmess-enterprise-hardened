...
class MockQueryBuilderImpl implements MockQueryBuilder {
  ...
  async then(resolve: (value: { data: unknown[]; error: null }) => void): Promise<void> {
  ...
  private _mockData(): unknown[] {
    switch (this._table) {
      case 'affiliates':
        return [
          { id: '1', username: 'alpha_wolf', tier: 'gold', total_conversions: 247, total_revenue: 12450 },
          { id: '2', username: 'street_king', tier: 'silver', total_conversions: 156, total_revenue: 7800 },
          { id: '3', username: 'night_rider', tier: 'bronze', total_conversions: 89, total_revenue: 4450 },
          { id: '4', username: 'urban_legend', tier: 'iron', total_conversions: 34, total_revenue: 1700 }
        ]
      case 'scans':
        return []
      case 'checkins':
