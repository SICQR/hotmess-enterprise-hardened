            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="body-large">
                  Brutalist luxury editorial platform combining live radio,
                  commerce, and AI culture.
                </p>
              </div>
              <div>
                <p className="label text-metal mb-2">BODY</p>
                <p className="body">
                  Raw typographic scale with monochrome base and tactical
                  texture. Strong kinetic motion.
                </p>
              </div>
              <div>
                <p className="label text-metal mb-2">BODY SMALL</p>
                <p className="body-small">
                  Editorial grid layout with tactile texture and audio-reactive
                  visual cues.
                </p>
              </div>
              <div>
      ...
      <section className="container mx-auto px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card-brutalist text-center">
            ...
            <p className="body-small text-metal">
              Brutalist outline, fills on hover
            </p>
          </div>
      ...
      <section className="py-24 bg-charcoal">
        <div className="container mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
              className="card-brutalist-hover motion-fade-in text-center"
      ...
      <section className="gradient-hotmess py-32 motion-tear">
        <div className="container mx-auto px-8 text-center">
          ...
          <p className="body-large text-paper max-w-2xl mx-auto mb-12">
            Complete brand system with logos, gradients, typography, animations,
            and accessibility-compliant design tokens. Ready for production.
          </p>
