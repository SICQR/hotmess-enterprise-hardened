  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        {showCrisisResources && (
          <Card
            className="mt-8 p-8 border-2 border-destructive bg-destructive/10"
            role="alert"
            aria-live="polite"
          >
            ...
            <p className="text-lg mb-6">
              If you're in crisis or thinking about self-harm, please reach out
            ...
            <div className="space-y-4 text-lg">
              <div>
                ...
                <a href="tel:988" className="text-accent hover:underline">
                  988 (call or text)
                </a>
              </div>
              <div>
                <div className="font-bold">Crisis Text Line</div>
                <a href="sms:741741" className="text-accent hover:underline">
                  Text HOME to 741741
                </a>
              </div>
              <div>
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground">
          <p>
            HOTMESS provides peer support but is not a substitute for
            professional mental health care. If you're experiencing a crisis,
            please contact emergency services or a crisis hotline.
          </p>
          <p className="mt-4">
            All check-ins are confidential and used only to improve our
            community support.
          </p>
        </div>
      </div>
