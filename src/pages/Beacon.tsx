  ...
  useEffect(() => {
    ...
    switch (action.type) {
          ...
          setContent(
            <div className="mt-4 bg-[#1a1a1a] p-6 rounded">
              ...
              <button
                ...
                onClick={() =>
                  alert("Added to bag! Enjoy your exclusive drop.")
                }
              >
                Add to Bag
              </button>
        ...
        setContent(
          <div className="mt-4 bg-[#1a1a1a] p-6 rounded">
            ...
            <p className="opacity-80">
              Price: £{action.event.price.toFixed(2)}
            </p>
            <button
              className="mt-4 bg-red-700 hover:bg-red-800 px-6 py-2 rounded text-white font-bold"
              onClick={() =>
                alert("Ticket purchase flow is not implemented in this demo.")
              }
            >
              Buy Ticket
            </button>
      ...
      case "chat": {
        ...
        setContent(
          <div className="mt-4 bg-[#1a1a1a] p-6 rounded">
            ...
            <p className="opacity-80">
              Scan to join our chat and meet fellow mess-makers.
            </p>
            <a
              href={action.url}
      ...
      case "checkin": {
        ...
        setContent(
          <p className="mt-4">
            Thanks for checking in. Remember to hydrate and decompress.
          </p>,
        );
        break;
      }
