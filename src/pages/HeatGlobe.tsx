  ...
  return (
    <div className="px-4 py-12 max-w-5xl mx-auto">
      ...
      <p className="mb-6 opacity-80">
        ...
        energy becomes visible. Host a beacon if your tier unlocks it: from at‑home
        curiosity to warehouse meet‑points, private buyer rooms and DJ pulses.
        Every scan earns status and opens new corners of our world.
      </p>
      ...
      <div className="relative mx-auto w-64 h-64 mb-8">
        ...
        <p className="absolute bottom-0 left-0 right-0 text-center text-xs mt-2 opacity-50">Interactive globe coming soon</p>
      </div>
      <div className="space-y-4">
        <h2 className="text-2xl font-bold">Explore & Earn</h2>
        <p className="opacity-80 max-w-xl">
          Use your finger or mouse to spin the globe (in the future) and see which
          areas are pulsing. Scan the associated QR codes to join a room, claim
          a drop or simply check in. The more you explore, the more points you
          earn.
        </p>
        <div className="flex flex-wrap gap-4">
          <button
            onClick={() => alert('Scan page will open and parse your QR beacon.')} 
          ...
          <button
            onClick={() => alert('Head to the Shop and find gear that matches your vibe')} 
            className="bg-red-700 hover:bg-red-800 text-white px-6 py-3 rounded font-bold"
          >
            Shop Drops
          </button>
