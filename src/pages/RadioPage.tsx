      ...
      <div className="container mx-auto px-4 py-12 space-y-12">
            ...
            {Object.entries(groupedSchedule).map(([day, shows]) => (
              <div key={day}>
                ...
                <div className="grid gap-4">
                  {shows.map(show => (
                    <Card key={show.id} className={`p-6 border-2 ${show.isLive ? 'border-accent' : 'border-border'}`}>
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground mb-2">
                            Hosted by <span className="text-foreground font-medium">{show.host}</span>
                          </p>
        ...
        <section className="bg-card border-2 border-border p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Our independent music label featuring underground artists<br />
