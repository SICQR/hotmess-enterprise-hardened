...
const blueprints: Blueprint[] = [
  {
    ...
    description:
      "Automatically track affiliate conversions, log to Google Sheets, update Airtable, and send Slack notifications when milestones are hit.",
    icon: CurrencyDollar,
  ...
  },
  {
    ...
    description:
      "Automatically escalate low mood scores to support team via SMS, create tickets in Notion, and schedule follow-ups.",
    icon: Lightning,
  ...
  },
  {
    ...
    description:
      "Sync Shopify products to Airtable, generate images, and auto-publish to social media when products are updated.",
    icon: Package,
  ...
  },
  {
    ...
    description:
      "Automatically start streams, send push notifications to subscribers, and post to social media when shows begin.",
    icon: Calendar,
    event: "show.started",
  ...
  },
  {
    ...
    description:
      "Monthly automated payout calculation, CSV generation, PayPal batch payments, and email statements to affiliates.",
    icon: Rocket,
  ...
  const handleTestWebhook = async (blueprint: Blueprint) => {
    ...
    try {
      ...
      if (success) {
        ...
        toast.error(
          `No webhook URL configured for ${blueprint.event}. Add it to your .env file.`,
        );
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Pre-built Make.com scenarios for common operations. Download, import
            to Make.com, and connect your webhook URLs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          {blueprints.map((blueprint) => {
            ...
            return (
              <Card
                key={blueprint.id}
                className="p-8 border-2 border-border hover:border-accent transition-all"
              >
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div>
                        <h4 className="font-bold text-sm uppercase text-muted-foreground mb-2">
                          Triggers
                        </h4>
