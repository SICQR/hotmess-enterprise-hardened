  ...
  return (
    <div className="px-4 py-12 max-w-4xl mx-auto">
      ...
      <ul className="list-disc ml-8 space-y-2 mb-4">
        <li>
          We collect minimal data to run this app, stored locally in Spark KV or
          sessionStorage.
        </li>
        <li>
          We use analytics to understand aggregated usage, but we never track
          individual identities.
        </li>
        <li>
          All data collection is purpose-limited and requires your consent.
        </li>
        <li>
          You can delete your local data at any time via your browser settings.
        </li>
      </ul>
    </div>
  );
