  ...
  return (
    <div className="px-4 py-12 max-w-4xl mx-auto">
      ...
      <p className="mb-6 opacity-80">
        Please read these terms carefully. By using HOTMESS, you agree to the following:
      </p>
      <ul className="list-disc ml-8 space-y-2 mb-4">
        <li>HOTMESS is a men‑only, 18+ platform. You must be over 18 and consenting to use it.</li>
        <li>All content is for entertainment and informational purposes only; no medical advice.</li>
